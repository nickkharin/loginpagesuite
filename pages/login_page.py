...
class LoginPage(BasePage):
    username_def = 'tomsmith'
    password_def = 'SuperSecretPassword!'
    ...
    def should_be_user_login_in(self, username=username_def, password=password_def):
    ...
    def should_be_red_message(self):
        assert self.is_element_present(*LoginPageLocators.RED_MESSAGE), "There isn't a failed login message," \
                                                                        " but inputs are incorrect"

    def should_not_be_red_message(self):
        assert self.is_not_element_present(*LoginPageLocators.RED_MESSAGE), "There is a red message," \
